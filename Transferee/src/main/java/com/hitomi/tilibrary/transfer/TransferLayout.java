...
public class TransferLayout extends FrameLayout {
    ...
    private TransferLayoutViewPagerPageChangeListener transferLayoutViewPagerPageChangeListener;

    public interface TransferLayoutViewPagerPageChangeListener {
        void onTransferLayoutPageSelected(int position);
    }
    ...
    private ViewPager.OnPageChangeListener transChangeListener = new ViewPager.SimpleOnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (transferLayoutViewPagerPageChangeListener != null) {
                transferLayoutViewPagerPageChangeListener.onTransferLayoutPageSelected(position);
            }
        }
    };
    /**
     ...
     * @param context 上下文环境
     */
    TransferLayout(Context context, TransferLayoutViewPagerPageChangeListener transferLayoutViewPagerPageChangeListener) {
        super(context);
