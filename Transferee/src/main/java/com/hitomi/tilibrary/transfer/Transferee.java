...
public class Transferee implements DialogInterface.OnShowListener,
    ...
    private TransferLayout.TransferLayoutViewPagerPageChangeListener transferLayoutViewPagerPageChangeListener;
     ...
     * @param context 上下文环境
     */
    private Transferee(Context context, TransferLayout.TransferLayoutViewPagerPageChangeListener transferLayoutViewPagerPageChangeListener) {
        this.transferLayoutViewPagerPageChangeListener = transferLayoutViewPagerPageChangeListener;
        this.context = context;
        creatLayout();
        createDialog();
    }
     ...
     * @return {@link Transferee}
     */
    public static Transferee getDefault(Context context, TransferLayout.TransferLayoutViewPagerPageChangeListener transferLayoutViewPagerPageChangeListener) {

        return new Transferee(context, transferLayoutViewPagerPageChangeListener);
    }

    public void setTransferLayoutViewPagerPageChangeListener(TransferLayout.TransferLayoutViewPagerPageChangeListener transferLayoutViewPagerPageChangeListener) {
        this.transferLayoutViewPagerPageChangeListener = transferLayoutViewPagerPageChangeListener;
    }


    private void creatLayout() {
        transLayout = new TransferLayout(context, transferLayoutViewPagerPageChangeListener);
