package com.hitomi.tilibrary.glideloader;
...
import com.hitomi.tilibrary.glideloader.support.ProgressTarget;
        ...
        ProgressTarget<String, GlideDrawable> progressTarget =
                new ProgressTarget<String, GlideDrawable>(srcUrl, new GlideDrawableImageViewTarget(imageView)) {
                    ...
                    protected void onStartDownload() {
                        Log.v("ABLEProduct", "GlideImageLoader onStartDownload1111:");
                    ...
                    protected void onDownloading(long bytesRead, long expectedLength) {
                        ...
                        Log.v("ABLEProduct", "GlideImageLoader onDownloading2222:" + ((int) (bytesRead * 100 / expectedLength)));
                    }

                    @Override
                    protected void onDownloaded() {
                        Log.v("ABLEProduct", "GlideImageLoader onStartDownload3333:");
                        sourceCallback.onFinish();
                    }

                    @Override
                    protected void onDelivered(int status) {
                        Log.v("ABLEProduct", "GlideImageLoader onStartDownload4444:");
